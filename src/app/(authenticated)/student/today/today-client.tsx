            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {dayOfWeek === 0 && (
                <div
                  ...
                  style={{ padding: "26px 22px", textAlign: "center", borderColor: isEvening ? "rgba(184,134,11,0.5)" : rgba(student.color, 0.25) }}
                >
                  ...
                  <div style={{ marginTop: 14, paddingTop: 12, borderTop: "1px solid rgba(184,134,11,0.15)", fontSize: 13, color: isEvening ? "#E8A820" : "#D4A830", fontWeight: 600 }}>
                    {isEvening ? "Tech time is unlocked — enjoy!" : `🔒 Tech time unlocks at ${formatUnlockTime(TECH_TIME_HOUR)}`}
                  </div>
                </div>
              )}
              ...
              {dayOfWeek === 6 && (
                <>
                  ...
                  >
                    ...
                    <div style={{ marginTop: 14, paddingTop: 12, borderTop: "1px solid rgba(255,255,255,0.06)", fontSize: 13, color: isEvening ? "#D4A830" : "#506070" }}>
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src="/assets/icon-techtime-unlocked.png" alt="" style={{ width: 16, height: 16, objectFit: "contain", verticalAlign: "middle", marginRight: 6, opacity: 0.7 }} />
                      {isEvening ? "Tech time is unlocked — enjoy!" : `Tech time unlocks at ${formatUnlockTime(TECH_TIME_HOUR)}.`}
                    </div>
                  </div>
                  {lateTasks.length > 0 && (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="task-card-body">
                      <div
                        style={{ fontWeight: 700, fontSize: 15, color: isCancelled ? "#506070" : "#F0E8D8", lineHeight: 1.2 }}
                      >
                        {task.subjectName}
                      </div>
                      {isCancelled ? (
          ...
          {techTimeEarned && tasks.length > 0 && (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                />
                <div>
                  <div className="cinzel" style={{ fontSize: 14, fontWeight: 700, color: isEvening ? "#E8A820" : "#D4A830" }}>
                    Great Job
                  </div>
