...
const PROFILES = [
  ...
  },
  {
    ...
    sub: process.env.NEXT_PUBLIC_BARNARD_STUDENT1_TAGLINE ?? "",
    img: "/assets/profile-admin-framed.png",
  },
  {
    id: "student2",
    ...
    sub: process.env.NEXT_PUBLIC_BARNARD_STUDENT2_TAGLINE ?? "",
    img: "/assets/profile-admin-framed.png",
  },
].filter((p) => p.email !== "");

export default function BarnardLoginPage() {
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 480, marginTop: -30 }}>
        ...
        >
          ...
          {!who ? (
            ...
            <>
              ...
              />
              {err && (
                <div style={{ color: "#F08080", fontSize: 13, textAlign: "center", marginBottom: 8 }}>{err}</div>
              )}
              <button
                type="button"
                className="btn-brass"
        ...
        <div
          style={{ textAlign: "center", marginTop: 14, fontSize: 13, color: "#3A4858", letterSpacing: "0.12em" }}
        >
